...
//The class Movie is a Plain Old Java Object (POJO) class for storing the data about one
//movie. It includes the following items:
...
public class Movie {
    ...
    //Eight getter methods to return the private information such as the method
    //getGenres that returns a String of all the genres for this movie.
    ...
    //A toString method for representing movie information as a String so it can easily
    //be printed
